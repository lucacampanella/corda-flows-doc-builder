...
//        g2 = new SVGGraphics2D(15000, 15000);
//
//
//        GUtils.fillWithColor(g2, new Rectangle(0,0,width,height), Color.WHITE);
//
//        GSubFlowWithCounterparty mainHolder = new GSubFlowWithCounterparty();
//        final Iterator<Map.Entry<String, GSubFlow>> iterator = gSessionsMap.entrySet().iterator();
//        mainHolder.setMainSubFlow(iterator.next().getValue());
//        if(iterator.hasNext()) {
//            mainHolder.setCounterpartySubFlow(iterator.next().getValue(), null);
//        }
//        mainHolder.setStart(BORDER, BORDER);
//        mainHolder.computeDimsStartingFrom(g2, null);
//        mainHolder.draw(g2);
//
////        int currentX = BORDER;
