...
public class CordaSubflowsNotMatchingTestFlow {
    ...
    public static class Acceptor extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            //the next two lines are in the wrong order
            SignedTransaction signedTx = subFlow(new ReceiveFinalityFlow(otherPartySession, null));
